...
void test_function(char* testName, int nTimes, int seed, double expectedValue, int N,
    double function_fn(int N, double[N]), double lower[N], double upper[N], bool logDesResults)
{
    printf("Test: %s\n", testName);
...
void test_function_with_statistics(FILE* error_file, FILE* times_file, char* test_name, int n_times, int seed,
    ...
    double upper[N])
{
    ...
    std = sqrt(std);
    double mili = 0.001;
    fprintf(times_file, "%s;%d;%f;%f;%f;%f;%f\n", test_name, N, best * mili, worst * mili, mean * mili, median * mili,
        std * mili);
}
...
void test_simple_quadratic(FILE* error_file, FILE* times_file, int nTimes, int seed)
{
    ...
    // test_function(name, nTimes, seed, -9.0, 1, fun_simple_quadratic, lower,
    // upper, false);
    test_function_with_statistics(error_file, times_file, name, nTimes, seed, expected_value, N, fun_simple_quadratic,
        lower, upper);
}
...
void test_sin_cos(FILE* error_file, FILE* times_file, int nTimes, int seed)
{
    ...
    // test_function(name, nTimes, seed, expected_value, 2, fun_sin_cos, lower,
    // upper, false);
    test_function_with_statistics(error_file, times_file, name, nTimes, seed, expected_value, N, fun_sin_cos, lower,
        upper);
}
...
void test_Ackeleya(FILE* error_file, FILE* times_file, int nTimes, int seed, int dim)
{
    ...
    // test_function(name, nTimes, seed, expected_value, N, fun_Ackleya, lower,
    // upper, false);
    test_function_with_statistics(error_file, times_file, name, nTimes, seed, expected_value, N, fun_Ackleya, lower,
        upper);
}
...
void test_Rastrigin(FILE* error_file, FILE* times_file, int nTimes, int seed, int dim)
{
    ...
    double expected_value = 0;
    // test_function(name, nTimes, seed, expected_value, N, fun_Rastrigin, lower,
    // upper, false);
    test_function_with_statistics(error_file, times_file, name, nTimes, seed, expected_value, N, fun_Rastrigin, lower,
        upper);
}
...
void test_Shubert(FILE* error_file, FILE* times_file, int nTimes, int seed)
{
    ...
    // test_function(name, nTimes, seed, expected_value, N, fun_Shubert, lower,
    // upper, false);
    test_function_with_statistics(error_file, times_file, name, nTimes, seed, expected_value, N, fun_Shubert, lower,
        upper);
}
...
void test_Shekel(FILE* error_file, FILE* times_file, int nTimes, int seed)
{
    ...
    // test_function(name, nTimes, seed, expected_value, N, fun_Shekel, lower,
    // upper, false);
    test_function_with_statistics(error_file, times_file, name, nTimes, seed, expected_value, N, fun_Shekel, lower,
        upper);
}
...
void test_Griewank(FILE* error_file, FILE* times_file, int nTimes, int seed, int dim)
{
    ...
    double expected_value = 0;
    // test_function(name, nTimes, seed, expected_value, N, fun_Griewank, lower,
    // upper, false);
    test_function_with_statistics(error_file, times_file, name, nTimes, seed, expected_value, N, fun_Griewank, lower,
        upper);
}
...
void test_Perm(FILE* error_file, FILE* times_file, int nTimes, int seed, int dim)
{
    ...
    double expected_value = 0;
    // test_function(name, nTimes, seed, expected_value, N, fun_Perm, lower,
    // upper, false);
    test_function_with_statistics(error_file, times_file, name, nTimes, seed, expected_value, N, fun_Perm, lower,
        upper);
}
...
void test_rotated(FILE* error_file, FILE* times_file, int nTimes, int seed, int dim)
{
    ...
    double expected_value = 0;
    // test_function(name, nTimes, seed, expected_value, N, fun_rotated, lower,
    // upper, false);
    test_function_with_statistics(error_file, times_file, name, nTimes, seed, expected_value, N, fun_rotated, lower,
        upper);
}
...
void test_Zakharov(FILE* error_file, FILE* times_file, int nTimes, int seed, int dim)
{
    ...
    double expected_value = 0;
    // test_function(name, nTimes, seed, expected_value, N, fun_Zakharov, lower,
    // upper, false);
    test_function_with_statistics(error_file, times_file, name, nTimes, seed, expected_value, N, fun_Zakharov, lower,
        upper);
}
